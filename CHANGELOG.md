...
- The following resources were added: AWS::AgentRegistry::Registry and
  AWS::AgentRegistry::RegistryRecord. [Github Actions]
...
- The following resources were added: AWS::RTBFabric::Link,
  AWS::RTBFabric::RequesterGateway and AWS::RTBFabric::ResponderGateway.
  [Github Actions]
...
- The following resource was updated:
  AWS::KinesisAnalyticsV2::Application. [Github Actions]
